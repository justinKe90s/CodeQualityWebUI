<template>
  <div>
    <div>
      <el-table
        :data="tableData"
        style="width: 1040px;margin-bottom: 20px;margin-left: 200px;margin-top: 40px;"
      ...
      >
        <el-table-column type="expand">
          <template slot-scope="props">
            ...
            >
              <el-table-column type="expand">
                <template slot-scope="props">
                  ...
                  >
                      ...
                      <template slot-scope="props">
                        ...
                        >
                          ...
                          <el-table-column label="操作" width="160" align="center">
                            <template slot-scope="props">
                              <el-button type="text" size="small" align="center" @click="Funcin(props)">查看具体分析</el-button>
                            </template>
                          </el-table-column>
                        </el-table>
                      </template>
                    ...
                    <el-table-column label="操作" width="160" align="center">
                      <template slot-scope="props">
                        <el-button type="text" size="small" align="center" @click="Classin(props)">查看具体分析</el-button>
                      </template>
                    </el-table-column>
                  </el-table>
                </template>
              ...
              <el-table-column label="操作" width="160" align="center">
                <template slot-scope="props">
                  <el-button type="text" size="small" align="center" @click="Filein(props)">查看具体分析</el-button>
                </template>
              </el-table-column>
            </el-table>
          </template>
        ...
        <el-table-column label="操作" width="160" align="center">
          <template slot-scope="props">
            <el-button type="text" size="small" align="center" @click="Projectin(props)">查看具体分析</el-button>
          </template>
        </el-table-column>
      </el-table>

      <el-button class="Back" type="primary" @click="back">返回</el-button>
      <el-button class="Look" type="primary" @click="Look">查看其他历史版本</el-button>
